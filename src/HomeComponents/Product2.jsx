            ...
            <div className='mt-1' >
                ...
                <div className='d-flex flex-row justify-content-between'>
                  <div className=' ml-auto mr-auto d-flex flex-column'>
                   <small className='pww p-2'  >Top Rated Mobiles</small>
                    <small className='ml-auto mr-auto' style={{borderBottom:'2px solid lightskyblue',width:'90px'}}></small>
                  </div>
                    <div className='mr-4'>
                        ...
                        return (
                            <>
                                ...
                                <div ref={columnRef} className='card col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2   pdis' style={{ height: '275px',boxShadow:'rgba(0, 0, 0, 0.15) 0px 15px 25px, rgba(0, 0, 0, 0.05) 0px 5px 10px',borderRadius:'10px',borderLeft:'none',borderRight:'none',borderTop:'2px solid lightgray' }}>
                                    <LazyLoadImage className='p-3 ml-auto mr-auto zoom-effect d-flex flex-row justify-content-center' src={e.ImageUrl} onClick={() => { navigate('/Dis', { state: { data: e } }) }} alt="Description of the image" effect="blur" height={'175px'} width={'100%'} style={{ cursor: 'pointer', objectFit: 'contain' }} />

                                    <small className='ml-auto mr-auto pwwww' style={{ cursor: 'pointer' }} onClick={() => { navigate('/Dis', { state: { data: e } }) }}><TruncateWords text={e.Product_Name.Product_Name} maxLength={15} /></small>
                                    <div className='d-flex flex-row ml-auto mr-auto ' style={{ cursor: 'pointer' }} onClick={() => { navigate('/Dis', { state: { data: e } }) }}>
